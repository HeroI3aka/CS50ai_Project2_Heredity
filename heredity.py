...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if not mother and not father:
            ...
            prob_father = inherit_probability(father, one_gene, two_genes)
            prob_mother = inherit_probability(mother, one_gene, two_genes)

            if person_gene == 2:
                person_prob *= prob_mother * prob_father
            elif person_gene == 1:
                person_prob *= (1 - prob_mother) * prob_father + (1 - prob_father) * prob_mother
            else:
                person_prob *= (1 - prob_father) * (1 - prob_mother)
